...
function MiddleBot({}: Props) {
  const bottomLeftMountainDetails = useSceneryStore(
    (state) => state.bottomLeftMountainDetails,
  );
  const bottomRightMountainDetails = useSceneryStore(
    (state) => state.bottomRightMountainDetails,
  );
  ...
  return (
    <>
      ...
      <div
        ...
        className="h-1/5 grid grid-rows-2 grid-cols-11 overflow-x-hidden overflow-y-hidden"
      >
