...
function FurthestLayer({}: Props) {
  const setTopRightMountainDetails = useSceneryStore(
    (state) => state.setTopRightMountainDetails,
  );
  const setTopLeftMountainDetails = useSceneryStore(
    (state) => state.setTopLeftMountainDetails,
  );
