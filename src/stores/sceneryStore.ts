...
export const useSceneryStore = create<SceneryState>((set) => ({
  ...
  setTopRightMountainDetails: (details) =>
    set({ topRightMountainDetails: details }),
  setTopLeftMountainDetails: (details) =>
    set({ topLeftMountainDetails: details }),
  setBottomRightMountainDetails: (details) =>
    set({ bottomRightMountainDetails: details }),
  setBottomLeftMountainDetails: (details) =>
    set({ bottomLeftMountainDetails: details }),
}));
